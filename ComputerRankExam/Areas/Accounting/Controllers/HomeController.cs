...
using ComputerRankExam.Areas.Accounting.Models;
using ComputerRankExam.Filters;

namespace ComputerRankExam.Areas.Accounting.Controllers
{
    public class HomeController : Controller
    {
        ...
        private string ExamDomain = tbll.GetExamType("2").ExamDomain;
        ...
        public ActionResult List(string id, int page = 1)
        {
            ...
            BLL_ExamType bllExamType = new BLL_ExamType();
            T_ExamType model = bllExamType.GetExamType("2");
        ...
        public ActionResult DownLoad()
        {
            ...
            viewModel.examDomain = ExamDomain;
